// /dashboard/accountant/layout.jsx
"use client";
...
export default function AccountantLayout({ children }) {
  ...
  const navigation = [
    { name: "Tableau de bord", href: "/dashboard/accountant", icon: faChartBar },
    { name: "Paiements", href: "/dashboard/accountant/payments", icon: faMoneyBill },
    { name: "Reçus", href: "/dashboard/accountant/receipts", icon: faReceipt },
    { name: "Factures", href: "/dashboard/accountant/invoices", icon: faFileInvoiceDollar },
    { name: "Rapports", href: "/dashboard/accountant/reports", icon: faChartLine },
  ];
        ...
        <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
          ...
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            <div className="flex-shrink-0 flex items-center px-4">
              <h1 className="text-xl font-bold text-gray-900">ScolaTek Comptable</h1>
            </div>
          ...
          <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
            <div className="flex items-center w-full">
              ...
              <div className="ml-3 flex-1">
                ...
                <p className="text-xs font-medium text-gray-500 capitalize">Comptable</p>
          ...
          <div className="flex-1 px-4 flex justify-between">
            <div className="flex-1 flex items-center">
              <h2 className="text-xl font-semibold text-gray-800">
                {navigation.find(item => item.href === pathname)?.name || 'Comptable'}
              </h2>
            </div>
